...
var Layout = function Layout(_ref) {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
      showInputMask = _useState2[0],
      setShowInputMask = _useState2[1];

  var formikRegister = Object(formik__WEBPACK_IMPORTED_MODULE_9__["useFormik"])({
    initialValues: {
      name: "",
      email: "",
      phone: "",
    ...
    validationSchema: Object(yup__WEBPACK_IMPORTED_MODULE_10__["object"])({
      name: Object(yup__WEBPACK_IMPORTED_MODULE_10__["string"])().min(2).required(),
      email: Object(yup__WEBPACK_IMPORTED_MODULE_10__["string"])().email().min(4).required(),
      phone: Object(yup__WEBPACK_IMPORTED_MODULE_10__["string"])().min(9).max(9).required(),
      fPassword: Object(yup__WEBPACK_IMPORTED_MODULE_10__["string"])().min(6).max(20).required(),
      sPassword: Object(yup__WEBPACK_IMPORTED_MODULE_10__["string"])().min(6).max(20).required()
    }),
    onSubmit: function onSubmit(values) {
      onAuth(values.name, values.email, values.phone, values.fPassword, isSignUp);
    }
  });
  var formikLogin = Object(formik__WEBPACK_IMPORTED_MODULE_9__["useFormik"])({
    initialValues: {
      emailPhone: "",
      password: "",
      checkbox: ""
    ...
    validationSchema: Object(yup__WEBPACK_IMPORTED_MODULE_10__["object"])({
      emailPhone: Object(yup__WEBPACK_IMPORTED_MODULE_10__["string"])().min(2).required(),
      password: Object(yup__WEBPACK_IMPORTED_MODULE_10__["string"])().email().min(4).required(),
      checkbox: Object(yup__WEBPACK_IMPORTED_MODULE_10__["string"])().min(9).max(9).required()
    }),
    onSubmit: function onSubmit(values) {
  ...
  }, __jsx(_components___WEBPACK_IMPORTED_MODULE_11__["AuthModal"], {
...
//# sourceMappingURL=order.js.ceae49ae729bc8d2c049.hot-update.js.map