...
import { Card, Modal, Success } from "../../../components";
...
const OrderPage = props => {
	...
	const purchaseHandler = (phone, name, email, city, district, street, house, address, comment) => {
		...
		formData.append("payment_type", methodOfPayment + 1);
		formData.append("books", cartContext.getIds());
		return axios.post("orders/create", formData, {
			headers: {
